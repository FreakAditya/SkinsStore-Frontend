...
<body>
  ...
  <div class="hero">
    <div class="promo">
      <div class="promo-text">
        <h1>Exclusive offer on brand new Avengers Collection</h1>
        <p>Get 25% off on all products!</p>
        <div class="buttons">
    ...
    <div class="brand-icons-container">
      <div class="brand-icons-wrapper">
        ...
        <a href="https://www.apple.com">
          <img
            src="https://www.layers.shop/cdn/shop/files/Untitled-1_0002_Symbol-of-the-iPhone-logo.jpg?v=1673873290&width=1080"
            alt="Apple">
        </a>
        <a href="https://www.mi.com">
          <img src="https://www.layers.shop/cdn/shop/files/Untitled-1_0000_Xiaomi-logo.jpg?v=1673873289&width=1080g"
            alt="Xiaomi">
        </a>
        <a href="https://www.oneplus.com">
          <img src="https://www.layers.shop/cdn/shop/files/Untitled-1_0007_OnePlus-Logo.jpg?v=1673873290&width=1080"
            alt="OnePlus">
        </a>
        <a href="https://www.google.com">
          <img src="https://www.layers.shop/cdn/shop/files/Untitled-1_0013_google-logo-9824.jpg?v=1673873483&width=1080"
            alt="Google">
        </a>
      </div>
    </div>
  ...
  <div class="phone-container">
    ...
    <div class="phone-box">
      <img
        src="https://www.layers.shop/cdn/shop/files/iphone-14-pro-astro-rainbow_-_back_cb5382b1-7bfa-4052-bb7d-808e9c5c22ee.png?v=1680605465&width=1280"
        alt="Phone 3">
      <h3>Phone 3</h3>
      <p>$700</p>
      <button class="add-to-cart">Add to Cart</button>
    ...
    <div class="phone-box">
      <img src="https://www.layers.shop/cdn/shop/files/iphone-14-pro-charcoal-black_-_back_1.jpg?v=1680612073&width=840"
        alt="Phone 4">
      <h3>Phone 4</h3>
      <p>$800</p>
      <button class="add-to-cart">Add to Cart</button>
  ...
  <footer>
    <div class="footer-container">
      <div class="left">
        ...
        <p><a href="MobileSkin.php">Mobile Skins</a> | <a href="#" id="laptop-skins-link">Laptop Skins</a> | <a
            href="bestseller.php">Best Sellers</a> | <a href="trending.php">Trending Skins</a></p>
      </div>
      <div class="center">
        <h4>About Us</h4>
    ...
    <div class="copy">
      <p>&copy;
        <?php echo date('Y'); ?> My Skins Store. All rights reserved.
      </p>
    </div>
  </footer>
